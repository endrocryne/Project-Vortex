...
class Flight:
                ...
                while phase.solver.status == "running":
                    ...
                    if self.y_sol[2] < self.env.elevation:
                        ...
                        if valid_t_root:
                            ...
                            # If no root is found, use the last state as impact
                            self.t = self.t_final = self.solution[-1][0]
                            self.y_sol = self.impact_state = self.solution[-1][1:]
    ...
    def __init_solver_monitors(self):
        ...
        self.solution = []
        # Fix for initialization order bug: self.t_initial must be set before self.__init_flight_state() is called.
